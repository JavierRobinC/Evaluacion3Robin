<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="AgregarMedidor.aspx.cs" Inherits="Evaluacion3Web.AgregarMedidor" %>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <asp:RadioButtonList runat="server" ID="tipoRb1">
                            <asp:ListItem Selected="True" Value="1" Text="Digital"></asp:ListItem>
                            <asp:ListItem Value="2" Text="Analogico"></asp:ListItem>
                        </asp:RadioButtonList>
                    </div>
                    <div class="form-group">
                        <asp:Button runat="server" ID="agregarBtn" OnClick="agregarBtn_Click" Text="Agregar Medidor" CssClass="btn btn-primary" />
                    </div>
                </div>
            </div>
       </div>
